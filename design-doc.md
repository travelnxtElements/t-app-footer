The first thing to consider is whether the footer is for a web app or native app. Native apps usually dont have footers as that information is presented elsewhere in the app.
